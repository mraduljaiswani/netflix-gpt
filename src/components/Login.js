...
const Login = () => {
  ...
  return (
    <div>
      ...
      <div>
        <img
          className=" absolute w-screen h-screen object-cover md:absolute md:w-screen md:h-screen"
          src={BackgroundImage}
          alt=""
        />
      </div>
      <form
        className="form-container bg-black mx-auto my-36 left-0 right-0 p-14 w-full md:w-3/12 absolute rounded-lg shadow-lg "
